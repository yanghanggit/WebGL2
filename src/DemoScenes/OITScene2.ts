...
class OITScene2 extends WebGL2DemoScene {
    ...
    public leave(): OITScene2 {
        return this;
    }

    public resize(width: number, height: number): OITScene2 {
        const app = this.engine;
        const accumBuffer = this.accumBuffer;
